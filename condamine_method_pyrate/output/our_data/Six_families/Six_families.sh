...
Rscript "../../../prepare_pyrate_data.R" -i "../../../../raw_data/our_pbdb/pbdb_data_with_class_location_20240429.txt" -f "Hadrosauridae,Ceratopsidae,Ankylosauridae,Dromaeosauridae,Troodontidae,Tyrannosauridae"
