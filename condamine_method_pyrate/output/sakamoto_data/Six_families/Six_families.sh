...
Rscript "../../../prepare_pyrate_data.R" -i "../../../../raw_data/sakamoto_pbdb/PBDB_Occurrences-20190305.txt" -f "Hadrosauridae,Ceratopsidae,Ankylosauridae,Dromaeosauridae,Troodontidae,Tyrannosauridae"
